  ...
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__headline">{{$t('error404head')}}</div>
        <div class="bullshit__info">{{$t('error404info')}}</div>
        <a-button type="primary" @click="backHome">{{$t('returnHomeBtn')}}</a-button>
      </div>
    </div>
  </div>
</template>
